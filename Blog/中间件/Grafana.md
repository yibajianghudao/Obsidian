...
tags:  
isCJKLanguage: true  
date: 2025-11-20T09:34:55+08:00  
lastmod: 2026-02-24T16:53:14+08:00
---

## 安装  

参考 [Install Grafana](https://grafana.com/docs/grafana/latest/setup-grafana/installation/)  
默认监听在 3000 端口,初始帐号和密码都是 `admin`,第一次登陆需要修改密码  
...
在 管理 - 插件和数据 - 插件 页面启用 Zabbix 插件  
在 连接 - 数据源 页面新建一个数据源,选择 zabbix  
配置:  

- `Connection.url`: zabbix 服务器地址后添加 `/api_jsonrpc.php`,例如 `http://localhost/zabbix/api_jsonrpc.php`  
