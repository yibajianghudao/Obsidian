...
lastmod: 2026-01-15T14:49:25+08:00
---
## 显示代码文件  
...
这是因为如果文章没有设置`summary`属性,默认会裁剪文章的前70个字符作为摘要,hugo框架可以用[这个链接](https://discourse.gohugo.io/t/how-to-disable-the-summary-for-a-post/25203/2)的方式关闭.  
relearn主题可以在`_index`中直接关闭,我之前的脚本在`_index`模板中设置了:  
